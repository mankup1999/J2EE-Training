...
/**
 * Servlet implementation class modifyEmployeeInfo
 */
public class modifyEmployeeInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public modifyEmployeeInfo() {
        super();
